...
export default function SignUpForm() {
  ...
  return (
    <div className="max-w-md w-full rounded-none p-6 md:py-10 bg-white dark:bg-background h-full border-r-1 overflow-auto scroll dark:border-neutral-700">
      <h2 className=" text-xl text-neutral-800 dark:text-white font-bold">
        Welcome to College Connection
      </h2>
      <p className="text-neutral-600 text-sm max-w-sm mt-2 font-medium tracking-tight leading-none dark:text-muted-foreground">
