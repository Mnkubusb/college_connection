...
export const NoteImageForm = ({ initialData, noteId , noteListId }: NoteImageFormProps) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            await axios.patch(`/api/notes/${noteId}/notesList/${noteListId}`, values);
            toast.success("Note Image Updated successfully");
            toggleEdit();
            router.refresh();
        } catch (error) {
            toast.error("Error updating note image");
        }
    }
